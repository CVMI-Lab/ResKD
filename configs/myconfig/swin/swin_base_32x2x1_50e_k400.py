_base_ = [
    '../../_base_/models/swin_base.py', '../../_base_/default_runtime.py'
]
model =dict(backbone=dict(patch_size=(2,4,4), drop_path_rate=0.2, use_checkpoint=True), test_cfg=dict(max_testing_views=2))
...
work_dir = './work_dirs/swin_base_32x2x1_50e_k400'
