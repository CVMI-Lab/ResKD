_base_ = [
    '../../_base_/models/rkd_tsm_tsm.py', '../../_base_/schedules/sgd_rkd_50e.py',
    '../../_base_/default_runtime.py'
]

model = dict(backbone=dict(pretrained_t='checkpoints/tsm_r50_1x1x8_50e_sthv2_rgb.pth'),
...
work_dir = './work_dirs/rkd_tsm_1x1x8_100e_sthv2/'